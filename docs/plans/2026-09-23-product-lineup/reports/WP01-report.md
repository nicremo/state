...
2. **Phase 1 ist offen.** Solange der Integrations-Branch nicht auf `main` liegt, trägt der Draft-PR gegen `main` zusätzlich dessen Commits. Für die Abnahme des WP01 ist das ohne Wirkung, für den Merge-Zeitpunkt schon.
...
1. Phase 1 abschließen: Integrations-Branch nach `main`, Plan-Set nach `main`, Dependabot-PRs.
2. Diesen Draft-PR prüfen und per Squash mergen. WP01 steht an erster Stelle der Merge-Reihenfolge für Welle 1.
